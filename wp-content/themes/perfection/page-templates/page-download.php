...
<?php get_header('second'); ?>
    ...
    <div class="promo promo_inner">
        ...
        <div class="promo__wrap promo__wrap_inner">
            ...
            <div class="social social_inner">
                ...
                <div class="social_inner">
                    <a href="#" class="social_inner-item pagination__social-item_fb">

                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <path style="fill:#7c7f82;" d="M296.296,512H200.36V256h-64v-88.225l64-0.029l-0.104-51.976C200.256,43.794,219.773,0,304.556,0h70.588v88.242h-44.115
                                    c-33.016,0-34.604,12.328-34.604,35.342l-0.131,44.162h79.346l-9.354,88.225L296.36,256L296.296,512z"/>
                            </svg>

                    </a>
                    <a href="#" class="social_inner-item pagination__social-item_tw">

                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;"
                             xml:space="preserve">
	                            <path style="fill:#7c7f82;" d="M512.002,97.211c-18.84,8.354-39.082,14.001-60.33,16.54c21.686-13,38.342-33.585,46.186-58.115
		...
		C480.111,136.775,497.92,118.275,512.002,97.211z"/>
                    ...
                    <a href="#" class="social_inner-item pagination__social-item_gg">

                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 508.52 508.52" style="enable-background:new 0 0 508.52 508.52;" xml:space="preserve">
                                <path style="fill:#7c7f82;" d="M277.588,39.442H144.547c-59.624,0-115.752,45.195-115.752,97.54
                            ...
                            <polygon style="fill:#7c7f82;" points="413.172,133.741 413.172,39.442 381.39,39.442 381.39,133.741 286.042,133.741
